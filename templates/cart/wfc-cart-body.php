			...
			?>
					<div class="product">
						...
						<div class="product-details">
							<div class="product-title"><?php echo wp_kses_post( $product_name ); ?></div>
						</div>

						<div class="product-price"><?php echo wp_kses_post( $product_price ); ?></div>
							<div class="product-quantity">
							<input type="number" name="" id="<?php echo wp_kses_post( uniqid( 'wfc_' ) ); ?>" value="<?php echo wp_kses_post( $product_qty ); ?>" min="0" max="<?php echo wp_kses_post( $product_data->get_max_purchase_quantity() ); ?>">
						</div>
						...
						<div class="product-line-price"><?php echo wp_kses_post( WC()->cart->get_product_subtotal( $product_data, $product_qty, $cart_item, $cart_key ) ); ?></div>
					</div>
			<?php
		}
		?>
